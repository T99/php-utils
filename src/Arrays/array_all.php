...
/**
 * Returns true if every element from the input array satisfies the condition
 * defined by the specified callback.
 * 
 * If no callback is provided, the default callback checks if every element from
 * the input array is truthy.
 * 
