 ...
 * @param int $count The number of leading elements to retrieve, or the number
 * of trailing elements to exclude if negative.
 ...
 * preserved.
 * @return array The first $count elements of the given array, or all but the
 * last $count elements if $count is negative.
 */
function array_head(
	array $array,
	int $count = 1,
